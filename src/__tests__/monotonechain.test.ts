...
describe('MonotoneChain', () => {
  it('should find hull of triangle', () => {
    const algo = new MonotoneChain(TRIANGLE);
  ...
  it('should find hull of square', () => {
    const algo = new MonotoneChain(SQUARE);
    const hull = runToCompletion(algo);
  ...
  it('should find hull of square with interior points', () => {
    const algo = new MonotoneChain(SQUARE_WITH_INTERIOR);
    const hull = runToCompletion(algo);
  ...
  it('should find hull of pentagon', () => {
    const algo = new MonotoneChain(PENTAGON);
    const hull = runToCompletion(algo);
